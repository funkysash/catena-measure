...
all: BRG-wrapper.o BRGFH-wrapper.o DBGFH-wrapper.o DBG-wrapper.o \
	catena-blake2b.o catena-blake2bFH.o catena-measure 
...
catena-measure: $(SRCDIR)/catena-measure.c DBG-wrapper.o BRG-wrapper.o\
	DBGFH-wrapper.o BRGFH-wrapper.o catena-blake2b.o catena-blake2bFH.o
	$(CC) $(LDFLAGS) $(FAST) -o $(TARGETDIR)/$@ $(SRCDIR)/catena-measure.c \
